...
<div class="container">
      ...
      <h3 class="card-title" style="margin-left:90px;">Invoice #{{$order->o_id}}</h3>
                ...
                <div class="card">
                    ...
                    <div class="row pb-5 p-5">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <p class="mb-1">KAMANA</p>
                            <p class="mb-1">A-150,khodiyar nagar,Nana Varachha<br>Surat</p>
                            <p class="mb-1">395006</p>
                            <a  href="#">kamana@gamil.com</a>
        ...
        <button type="button" class="btn btn-primary print_btn button"  style="margin-left:490px; margin-top:20px;margin-bottom:20px;" >Print This Reciept</button>
