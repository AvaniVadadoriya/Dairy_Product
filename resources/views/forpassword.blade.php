...
<section class="login_box_area section_gap" >
		<div class="container" >
			<div class="row" >
			<div class="col-lg-4" style="margin-top:90px;margin-bottom:90px;margin-left:380px;box-shadow :0 0 20px rgba(0, 0, 0, 0.15);">
	...
	<form method="POST" action="{{url('forpassword')}}" class="row login_form" novalidate="novalidate">
        @csrf
        <input type="hidden" name="token" value={{$token}}>
        <div class="col-md-12 form-group">
            <label  ><b class="label">Forgot Password</b></label>
            <input type="password" name="password" id="password" placeholder="Enter New Password" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter New Password'">
